        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="images/brand.png" style="width: 50%;" class="logo" alt=""></a>
                </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-menu col-md-3">
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="sedangpromo_guest.php">Sedang Promo</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- end col-3 -->
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                    <div class="products-single fix">
                                        ...
                                        <div class="why-text">
                                            <a href="shop-detail_guest.php" style="color:#000000 ;"><b>Jaket The North Face</b></a>
                                            <h5>Rp800.000</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                    <div class="products-single fix">
                                        ...
                                        <div class="why-text">
                                            <a href="shop-detail.php" style="color:#000000 ;"><b>Tracktp Adidas</b></a>
                                            <h5>Rp400.000</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                    <div class="products-single fix">
                                        ...
                                        <div class="why-text">
                                            <a href="shop-detail.php" style="color:#000000 ;"><b>Hoodie Nike</b></a>
                                            <h5>Rp300.000</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                    <div class="products-single fix">
                                        <div class="box-img-hover">
                                            <img src="images/jaket ellese.jpg" class="img-fluid" alt="Image">
                                        </div>
                                        <div class="why-text">
                                            <a href="shop-detail.php" style="color:#000000 ;"><b>Jaket Ellesse</b></a>
                                            <h5>Rp300.000</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                    <div class="products-single fix">
                                        <div class="box-img-hover">
                                            <img src="images/jaket trucker.jpg" class="img-fluid" alt="Image">
                                        </div>
                                        <div class="why-text">
                                            <a href="shop-detail.php" style="color:#000000 ;"><b>Jaket Trucker</b></a>
                                            <h5>Rp200.000</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                    <div class="products-single fix">
                                        <div class="box-img-hover">
                                            <img src="images/cp company.jpg" class="img-fluid" alt="Image">
                                        </div>
                                        <div class="why-text">
                                            <a href="shop-detail.php" style="color:#000000 ;"><b>Cp Company</b></a>
                                            <h5>Rp800.000</h5>
                                        </div>
                                    </div>
                                </div>
