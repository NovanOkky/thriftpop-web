            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        ...
                        <a class="btn hvr-hover" href="jaket_guest.php">Jaket</a>
                    </div>
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/hoodie.jfif" alt="" />
                        <a class="btn hvr-hover" href="hoodie_guest.php">Hoodie</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/kaospolos.jfif" alt="" />
                        <a class="btn hvr-hover" href="kaos_guest.php">Kaos</a>
                    </div>
                    <div class="shop-cat-box">
                        ...
                        <a class="btn hvr-hover" href="celana_guest.php">Celana</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="https://cf.shopee.co.id/file/91d26f7215f1ffba1dfa983f6aa06d84" alt="" />
                        <a class="btn hvr-hover" href="vest_guest.php">Vest</a>
                    </div>
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/topi.jpg" alt="" />
                        <a class="btn hvr-hover" href="topi_guest.php">Topi</a>
                    </div>
                </div>
            </div>
        </div>
